      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {preview && (
          <button
            ...
            disabled={uploading}
            className="px-3 py-1.5 rounded-lg text-sm bg-primary text-primary-foreground hover:bg-primary/90 disabled:opacity-50 transition-colors"
          >
        ...
        {currentUrl && !preview && (
          <button
            ...
            disabled={uploading}
            className="px-3 py-1.5 rounded-lg text-sm text-destructive hover:bg-destructive/10 border border-destructive/30 disabled:opacity-50 transition-colors"
          >
